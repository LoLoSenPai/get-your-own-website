    ...
    return (
        ...
        <div
            ...
            <form className="my-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                    className="bg-gradient-to-r relative group/btn from-sky-600 to-fuchsia-600 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
                    type="submit"
                >
                    Send &rarr;
                    <BottomGradient />
