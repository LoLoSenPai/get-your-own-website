...
const SkeletonTwo = () => {
    ...
    const [randomWidth, setRandomWidth] = useState("100%"); // Valeur par défaut
    const arr = new Array(6).fill(0);

    useEffect(() => {
        // Calculer uniquement côté client
        setRandomWidth(Math.random() * (100 - 40) + 40 + "%");
    }, []);
    ...
    return (
        <motion.div
            ...
            <motion.div
                ...
                <IconBrandDiscord stroke={1.5} className="h-10 w-10 text-blue-700" />
                <p
                    className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
                    Ex: Get notified for new events.
                </p>
                <p
            ...
            <motion.div
                ...
                <IconBrandTelegram stroke={1.5} className="h-10 w-10 text-white bg-blue-600 rounded-full p-1" />
                <p
                    className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
                    Ex: You want your own game?
                </p>
                <p
            ...
            <motion.div
                variants={second}
                className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
                <IconAdjustmentsCode stroke={1.5} className="h-10 w-10 text-red-700" />
                <p
                    className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
        ...
        <motion.div
            ...
            <motion.div
                ...
                <p className="text-xs text-neutral-500">
                    Hello, I have an idea for a new project. It has to be on EVM, Solana, or Move?
                </p>
            </motion.div>
            <motion.div
                variants={variantsSecond}
                className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center justify-end space-x-2 w-3/4 ml-auto bg-white dark:bg-black">
                <p className="text-xs text-neutral-500">All of above mfer!</p>
                <Image
                    src="/cat-avatar.png"
                    alt="avatar"
                    height="100"
...
const items = [
    {
        title: "NFT Project Ideas",
        description: (
            <span className="text-sm">
                Get unique ideas for your NFT project.
            </span>
        ),
        header: <SkeletonOne />,
    ...
    {
        title: "Memecoin Ideas",
        description: (
            <span className="text-sm">
                Get ready to launch on every blockchain.
            </span>
        ),
        header: <SkeletonTwo />,
        className: "md:col-span-1",
    ...
    {
        title: "Discord/Telegram Bots & scripts",
        description: (
            <span className="text-sm">
                Get your own Discord/Telegram bot or script.
            </span>
        ),
        header: <SkeletonFour />,
